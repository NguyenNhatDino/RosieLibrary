...
if not Success then
	warn("\nRosie Library - Failed to load Feather Icons. Error code: " .. Response .. "\n")
end	
...
function RosieLibrary:Notification(Config)
	...
	spawn(function()
		...
		local RosieLibraryNotifyGui = Instance.new("ScreenGui");
		...
		RosieLibraryNotifyGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
		RosieLibraryNotifyGui.Name = "RosieLibraryNotifyGui"
		RosieLibraryNotifyGui.Parent = CoreGui
		...
		ShadowHolder1.Parent = RosieLibraryNotifyGui
...
function RosieLibrary:Window(GuiConfig)
	local GuiConfig = GuiConfig or {}
	GuiConfig.NameHub = GuiConfig.NameHub or "Rosie Library"
	GuiConfig.NameDev = GuiConfig.NameDev or "By Nguyen Nhat"
	...
	function Tabs:AddTab(TabConfig)
		...
		function Items:AddParagraph(ParagraphConfig)
			...
			ParagraphConfig.Icon = ParagraphConfig.Icon or "rbxassetid://16863343922"
			local ParagraphFunc = {}
		...
		function Items:AddInput(InputConfig)
			...
			InputConfig.Icon = InputConfig.Icon or "rbxassetid://16863343922"
		...
		function Items:AddButton(ButtonConfig)
			...
			ButtonConfig.Icon = ButtonConfig.Icon or "rbxassetid://16863343922"
